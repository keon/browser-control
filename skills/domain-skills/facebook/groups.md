...
**Requires:** browser-control driving a real Chrome that is (a) signed into
...
For simple or static pages, `http_get(url)` from browser-control itself is fine — it
...
Paste this into a browser-control stdin block to see what anchors currently exist in the
