...
**Requires:** a real Chrome driven by browser-control. Logged-in is recommended
...
Same pattern as groups — Pages are the walled-garden surface that browser-control is
