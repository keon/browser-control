...
- The home-page search input can behave like a tightly controlled app field: direct DOM value assignment may be cleared immediately, and CDP text insertion may fail to populate it even when the input is focused.
